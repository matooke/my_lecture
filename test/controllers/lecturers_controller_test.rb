...
class LecturersControllerTest < ActionController::TestCase
  ...
  test "should create lecturer" do
    assert_difference('Lecturer.count') do
      post :create, lecturer: { course: @lecturer.course, course_unit: @lecturer.course_unit, faculty: @lecturer.faculty, lecture_room: @lecturer.lecture_room, name: @lecturer.name, phone: @lecturer.phone }
    end
  ...
  test "should update lecturer" do
    patch :update, id: @lecturer, lecturer: { course: @lecturer.course, course_unit: @lecturer.course_unit, faculty: @lecturer.faculty, lecture_room: @lecturer.lecture_room, name: @lecturer.name, phone: @lecturer.phone }
    assert_redirected_to lecturer_path(assigns(:lecturer))
  end
